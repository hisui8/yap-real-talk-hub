...
const StatsStrip = () => {
  ...
  return (
    <section className="bg-gradient-to-r from-charcoal to-gunmetal py-20 px-4">
      <div className="container mx-auto">
        {/* Stats */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              <div className="text-4xl md:text-5xl font-bold text-sage mb-3 tracking-tight font-display">{stat.number}</div>
